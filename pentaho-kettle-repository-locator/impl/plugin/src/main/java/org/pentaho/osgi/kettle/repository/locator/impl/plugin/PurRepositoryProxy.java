...
public class PurRepositoryProxy implements Repository {
  ...
  public PurRepositoryProxy( PluginRegistry registry ) {
  ...
  private Repository getDelegate() {
    ...
    try {
      ...
      logger.debug( "Unable to load delegate class for plugin id \"{}\". PUR plugin is most likely not installed or changed id.", PUR_PLUGIN_ID );
  ...
  public void setLocationUrl( String locationUrl ) {
    RepositoryMeta repositoryMeta = this.getRepositoryMeta( locationUrl );
    this.getDelegate().init( repositoryMeta );
  }

  private RepositoryMeta getRepositoryMeta( String url ) {
    ...
    try {
      ...
      Class<?> purRepositoryLocationClass = registry.getClass( purPlugin, "org.pentaho.di.repository.pur.PurRepositoryLocation" );
      ...
      Class<?> purRepositoryMetaClass = registry.getClass( purPlugin, "org.pentaho.di.repository.pur.PurRepositoryMeta" );
